  ...
  .controller('BillCtrl', function ( _, $rootScope, $location, utilStringService, $localStorage,
    ...
    vm.printToCart = function (printSectionId) {
      var innerContents = document.getElementById(printSectionId).innerHTML;
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="https://github.com/mrZolutions/Integridad/blob/master/integridad-ui/app/styles/style-print.css" /></head><body onload="window.print()">' + innerContents + '</html>');
