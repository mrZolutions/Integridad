...
public class DailybookFv {
    ...
    private String dailyFvSeq;
    private String dailyFvStringSeq; //Generado automáticamente por el Sistema
    private String dailyFvStringUserSeq; //Introducido por el Usuario
    ...
    @OneToMany(mappedBy = "dailybookFv", cascade = CascadeType.ALL)
