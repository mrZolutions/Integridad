...
@Data
public class CreditNoteCellarReport {
    ...
    public CreditNoteCellarReport(String stringSeq, String dateCreated, String documentStringSeq, String status, Double baseDoce, Double baseCero, Double iva, Double total, String motivo) {
